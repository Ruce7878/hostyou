...
echo "<a href=\"mpanel.php?$ses&amp;do=clroom&amp;rm=$rm$takep\">Čišćenje svih soba (nenajavljeno)</a><br/>";  
...
echo "<a href=\"apanel.php?$ses&amp;go=delpp$takep\">Ciscenje procitanih pisama</a><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=delfotopp$takep\">Ciscenje Foto pisama(SVE)</a><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=fotoppfolder$takep\">Isprazni fotopp folder</a><br/>\n";
}
if($row["level"]>=7){
echo "<a href=\"apanel.php?$ses&amp;go=delpp$takep\">Ciscenje Inboxa</a><br/>\n";
}
if ($row["level"]>6){
echo "<b><a href=\"apanel.php?$ses&amp;go=pismod$takep\">Pismo adminima i modovima</a></b><br/>\n";
echo "<b><a href=\"apanel.php?$ses&amp;go=pismos$takep\">Pismo svima</a></b><br/>\n";
}
//echo $divide;
...
case 'upsobama':
echo "<a href=\"apanel.php?$ses&amp;go=natpisus$takep\">Tekst u sobi</a><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=premestisobu$takep\">Premesti Sobu</a><br/>\n";
echo "<b>Glave Sobe</b><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=editgrooms$takep\">Izmeni nazive soba</a><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=editposgroom$takep\">Izmeni poziciju soba</a><br/>\n";
echo "<a href=\"apanel.php?$ses$takep&amp;go=ukljgsobu$takep\">Ukljuci sobu</a><br/>\n";
echo "<a href=\"apanel.php?$ses$takep&amp;go=iskljgsobu$takep\">Iskljuci sobu</a><br/>\n";
echo "<b>Klubovi</b><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=editkrooms$takep\">Izmeni nazive soba</a><br/>\n";
echo "<a href=\"apanel.php?$ses&amp;go=editposkroom$takep\">Izmeni poziciju soba</a><br/>\n";
echo "<a href=\"apanel.php?$ses$takep&amp;go=ukljksobu$takep\">Ukljuci sobu</a><br/>\n";
echo "<a href=\"apanel.php?$ses$takep&amp;go=iskljksobu$takep\">Iskljuci sobu</a><br/><br/>\n";
break;
...
echo $fsize1;
echo "<anchor title=\"go\">Pošalji<go href=\"apanel.php?go=posaljipd&amp;$ses\" method=\"post\">\n";
...
if ((isset($rm))&&($rm!="")) echo "<form method=\"POST\" action=\"apanel.php?go=posaljipd&amp;$ses&amp;rm=$rm\" name=\"auth\">\n";
else echo "<form method=\"POST\" action=\"apanel.php?go=posaljipd&amp;$ses\" name=\"auth\">\n";
echo $fsize1;
echo "Naslov pisma:<br/>\n";
echo $fsize2;
...
case 'pismos':
$message = $topic = $towhom = "";
echo "<b>Pismo za sve članove:</b><br/>\n";
if($ver=="wml") {
echo $fsize1;
echo "Naslov pisma:<br/>\n";
echo $fsize2;
...
echo "<input name=\"message$ref\" maxlength=\"600\" value=\"$message\" title=\"message\"/><br/>\n";
echo $fsize1;
echo "<anchor title=\"go\">Pošalji<go href=\"apanel.php?go=posaljips&amp;$ses\" method=\"post\">\n";
echo "<postfield name=\"topic\" value=\"$(topic$ref)\"/>\n";
echo "<postfield name=\"message\" value=\"$(message$ref)\"/>\n";
echo "</go></anchor>\n";
echo $fsize2;
...
echo "<form method=\"POST\" action=\"apanel.php?go=posaljips&amp;$ses\" name=\"auth\">\n";
echo $fsize1;
//echo "Naslov pisma:<br/>\n";
//echo $fsize2;
//echo "<input name=\"topic\" maxlength=\"30\" value=\"$topic\" title=\"topic\"/><br/>\n";
