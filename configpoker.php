...
$server = "mysql3.000webhost.com";                              // Server Host
$DBusername = "a8365541_Error";                               // Database Username
$DBpassword = "steplant/stanhely";                                   // Database Password
$database = "a8365541_Chat";                       // Database Name
