...
if(!empty($text)){
$rand=rand(1,mysql_result(mysql_query("select count(id) from `bot_dialog_j`;"),0));
list($bot_text)=mysql_fetch_array(mysql_query("select message from `bot_dialog_j` where id='".$rand."';"));
}
else $bot_text='';
}
return $bot_text;
