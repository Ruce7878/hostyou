...
echo "<b>Dijalog Imedju $kojeje[0] i $dijalog[0]</b><br/>";
echo $divide;
echo $fsize2;
...
if($page>1){
$ppage = $page-1;
echo "<a href=\"dijalogg.php?$ses&amp;page=$ppage$takep&amp;nk=$nk\">&#171;Nazad</a> ";
}
if($page<$stranice){
$npage = $page+1;
echo "<a href=\"dijalogg.php?$ses&amp;page=$npage$takep&amp;nk=$nk\">Napred&#187;</a>";
}
echo "<br/>";
echo $fsize2;
}else{
