...
echo "<b>Primljena pisma od $kojeje[0]</b><br/>";
echo $divide;
echo $fsize2;
...
$brojcano = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM zapiski WHERE (idwho='".$kojeje[1]."' AND idtowhom='".$dijalog[1]."')"));
$start=(($page-1)*5);
...
$q = mysql_query("SELECT * FROM zapiski WHERE (idwho='".$kojeje[1]."' AND idtowhom='".$dijalog[1]."') ORDER BY time DESC LIMIT $start, 5");
echo $fsize1;
$st5=$start+5;
...
if($page>1){
$ppage = $page-1;
echo "<a href=\"dijalogpr.php?$ses&amp;page=$ppage$takep&amp;nk=$nk\">&#171;Nazad</a> ";
}
if($page<$stranice){
$npage = $page+1;
echo "<a href=\"dijalogpr.php?$ses&amp;page=$npage$takep&amp;nk=$nk\">Napred&#187;</a>";
}
echo "<br/>";
echo $fsize2;
}else{
