...
if ($rm == 2) require("mkviz1.php");
if ($rm == 3) require("anagram1.php");
...
$posts = mysql_fetch_array(mysql_query("SELECT id, posts FROM `users` WHERE id='".$id."'"));
if($posts[1]<'300'){
if ($rm==11){ echo "<div class=\"d1\"><b>$us,napisi gde si video/la adresu i dobijas postove :)</b></div>";}
}
...
$manje = time()-1800;
$gdeko = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE gdetime> '".$manje."'"));
echo "<a href=\"add.php?$ses&amp;rm=$rm$takep\" accesskey=\"$bind1\">Napisi </a>|<a href=\"who.php?$ses&amp;ref=$ref\"> Ko je gde(".$gdeko[0].") </a>|<a href=\"chat.php?$ses&amp;rm=$rm$takep\" accesskey=\"$bind2\"> Osvezi </a>|<a href=\"function.php?$ses&amp;rm=$rm$takep\" accesskey=\"3\"> Funkcije</a>";
echo $fsize2;
echo "</div>";
echo $fsize1;
}
...
echo $fsize1;
$smiliesss = mysql_fetch_array(mysql_query ("SELECT COUNT(*) FROM smilies"));
echo "<a href=\"smilies.php?$ses&amp;rm=$rm$takep\">Smajliji ($smiliesss[0])</a>|<a href=\"color.php?$ses&amp;ref=$ref\"> Boja nika </a>|<a href=\"poziv.php?$ses&amp;rm=$rm$takep\"> Pozovi chatera </a>|<a href=\"statistik.php?$ses&amp;rm=$rm$takep\">Statistika </a>|<a href=\"kiss.php?$ses&amp;rm=$rm$takep\"> Posalji Kiss </a>|<a href=\"enter.php?$ses&amp;ref=$ref\" accesskey=\"$bind4\"> Hodnik </a>|<a href=\"whoroom.php?$ses&amp;rm=$rm$takep\"> Ko je tu</a>";
$tm = time()-1800;
$sobe = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE gdetime>'".$tm."' AND gde='".$room."'"));
echo "<b><a href=\"chat.php?$ses&amp;rm=$rm&amp;ref=$ref\">$roomname ($sobe[0])</a></b><br/>";
///////////////////////////////////////////////////////////////////////Online u sobi///////////////////////////////
...
echo "<div class=\"d1\">";
echo $fsize2;
echo "&#169; <b>Powered by <a href=\"http://naruci-chat.tk/news/index.php\">Najbolja izrada chatova 2015</b></a></p>";
echo $fsize2;
echo $fsize1;
}
}else{
